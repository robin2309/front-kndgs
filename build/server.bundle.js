...
/***/ "./src/common/components/PostItem/PostItem.jsx":
/*!*****************************************************!*\
  !*** ./src/common/components/PostItem/PostItem.jsx ***!
  \*****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _react = __webpack_require__(/*! react */ \"react\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _propTypes = __webpack_require__(/*! prop-types */ \"prop-types\");\n\nvar _propTypes2 = _interopRequireDefault(_propTypes);\n\nvar _VoteContainer = __webpack_require__(/*! Containers/VoteContainer/VoteContainer */ \"./src/common/containers/VoteContainer/VoteContainer.jsx\");\n\nvar _VoteContainer2 = _interopRequireDefault(_VoteContainer);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar PostItem = function PostItem(_ref) {\n  var createdAt = _ref.createdAt,\n      id = _ref.id,\n      upVotes = _ref.upVotes,\n      downVotes = _ref.downVotes,\n      link = _ref.link,\n      title = _ref.title;\n\n  return _react2.default.createElement(\n    'div',\n    { className: 'post-item' },\n    _react2.default.createElement(_VoteContainer2.default, {\n      upVotes: upVotes,\n      downVotes: downVotes,\n      idPost: id\n    }),\n    _react2.default.createElement(\n      'a',\n      { className: 'post-item__link', href: link, target: '_blank' },\n      _react2.default.createElement(\n        'h2',\n        { className: 'post-item__title' },\n        title\n      )\n    )\n  );\n};\n\nPostItem.propTypes = {\n  createdAt: _propTypes2.default.string.isRequired,\n  id: _propTypes2.default.string.isRequired,\n  upVotes: _propTypes2.default.number.isRequired,\n  downVotes: _propTypes2.default.number.isRequired,\n  link: _propTypes2.default.string.isRequired,\n  title: _propTypes2.default.string.isRequired\n};\n\nexports.default = PostItem;\n\n//# sourceURL=webpack:///./src/common/components/PostItem/PostItem.jsx?");
...
/***/ "./src/common/components/Vote/Vote.jsx":
/*!*********************************************!*\
  !*** ./src/common/components/Vote/Vote.jsx ***!
  \*********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _reactRedux = __webpack_require__(/*! react-redux */ \"react-redux\");\n\nvar _Vote = __webpack_require__(/*! Components/Vote/Vote */ \"./src/common/components/Vote/Vote.jsx\");\n\nvar _Vote2 = _interopRequireDefault(_Vote);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar mapDispatchToProps = function mapDispatchToProps(dispatch) {\n  return {\n    onUpVote: function onUpVote() {\n      return dispatch({});\n    },\n    onDownVote: function onDownVote() {\n      return dispatch({});\n    }\n  };\n};\n\nexports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(_Vote2.default);\n\n//# sourceURL=webpack:///./src/common/containers/VoteContainer/VoteContainer.jsx?");
